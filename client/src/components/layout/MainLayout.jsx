...
export default function MainLayout() {
    ...
    useEffect(() => {
        try {
            ...
            const hasNoUsername = currentUser.hasSetUsername === false || currentUser.hasSetUsername === "false" || !currentUser.username;
            if (hasNoUsername && location.pathname === "/pods") {
    ...
    }, [location.pathname, usernameInput]);
                    ...
                    >
                        ...
                        <form onSubmit={handleUsernameSubmit} className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full py-2.5 rounded-xl border border-[var(--border-color)] hover:bg-[var(--bg-tertiary)] text-[var(--text-secondary)] text-xs font-semibold cursor-pointer transition-colors text-center mt-2"
                            >
                                Back to Dashboard
                            </button>
                        </form>
